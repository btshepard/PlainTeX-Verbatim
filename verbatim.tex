...
\def\obeyblanklines{\begingroup\lccode`~=`\^^M\relax\lowercase{\endgroup\def~}{\endgraf\ifblankline\vskip\baselineskip\fi\blanklinetrue}\makeactive{\^^M}\everypar{\blanklinefalse}}
...
\def\doverbatim#1{\ifx|#1\relax\makepipeother\expandafter\displayverb\else\inlineverb#1\fi}
